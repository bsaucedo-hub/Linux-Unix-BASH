...
if [ ! -d "$HOME/BACKUP_FILE"]; then
        mkdir "$HOME/BACK_FILES"
        echo "Created BACK_FILES in $HOME directory"
else
        echo "Directory $HOME/BACK_FILES exists."
fi
...
print_info () {
        echo "Files in $HOME/BACKUP_FILES"
        ls -al "$HOME/BACKUP_FILES"
        echo "Disk usage of $HOME/BACKUP_FILES:"
